                                    ...
                                    <div class=" info-box feture-tabs" data-aos="fade-up">
                                        <div class="col-lg-6">
                                            ...
                                            <ul class="nav nav-pills mb-3 justify-content-start">
                                                ...
                                                <li>
                                                    <a class="nav-link mb-3" data-bs-toggle="pill" href="#tab2"><i class="ri-file-line" style="font-size: 1.2rem; color: black"></i><span style="color: black; font-size: 1.2rem; margin-right: 10px;">الطلبات</span></a>
                                                </li>
                                                <li>
