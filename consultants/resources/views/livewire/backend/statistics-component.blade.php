            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="mb-2">{{trans('dashboard.SAR')}} {{ number_format($currentMonthEarning, 2) }}</h4>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="mb-2">{{trans('dashboard.SAR')}} {{ number_format($currentAnnualEarning, 2) }}</h4>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        <p class="text-truncate font-size-14 mb-2">{{trans('dashboard.All_finished_orders_(current monthh)')}}</p>
