            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-2 col-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bi bi-chevron-right scrollto"></i> <a href="{{route('site.privacy')}}">{{trans('site.Privacy_Policy')}}</a></li>
                        <li><i class="bi bi-chevron-right scrollto"></i> <a href="{{route('site.terms')}}">{{trans('site.Term_of_usage')}}</a></li>
